            ...
            <div class="col-md-3 col-xs-6">
              <div class="footer">
                ...
                <ul class="footer-links">
                  <li>
                    <a href="#"
                      ><i class="fa fa-map-marker"></i>234 Hồ Tây, Hoàn Kiếm, Hà Nội</a
                    >
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-phone"></i>+055555555</a>
                  </li>
                  <li>
                    <a href="#"
                      ><i class="fa fa-envelope-o"></i>cuongld@gmail.com</a
                    >
                  </li>
                </ul>
              </div>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <span class="copyright">
                ...
                All rights reserved | This template is made with by Cuong
