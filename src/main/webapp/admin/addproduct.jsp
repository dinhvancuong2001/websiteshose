                        ...
                        <div class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
                                      <form action="/shopshoe/AddProduct" method="post">

                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="squareInput">Tên sản phẩm</label>
                                                    <input type="text" class="form-control input-square" id="squareInput" placeholder="Tên sản phẩm" name = "name" required="required">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-square" id="squareInput" placeholder="Giới thiệu" required="required" name = "short_description">
                                                </div>
                                            </div>
                                        </div>   
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name = "price" class="form-control input-square" id="squareInput" placeholder="Giá gốc sản phẩm">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-square" id="squareInput" placeholder="Giá giảm" name = "discount">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-square" id="squareInput" placeholder="Số lượng" name = "quantity">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-square" id="squareInput" placeholder="Ảnh" name ="thumbnail" >
                                                </div>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="comment" rows="5" name = "description"></textarea>
                                                </div>
                                            </div>
                                        </div>  

                                        <button type="submit" class="card-title btn btn-primary" style="background-color: #007bff; color: #fff; border: #fff;font-size: 14px; "> Thêm sản phẩm</button>
