        ...
        <div id="responsive-nav">
          ...
          <ul class="main-nav nav navbar-nav">
            ...
            <li><a href="shoeArtifical">Giày cỏ nhân tạo</a></li>
              <li class="active"><a href="shoeFutsal">Giày Futsal</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <ul class="breadcrumb-tree">
              ...
              <li class="active">Giày Futsal</li>
            </ul>
          </div>
        </div>
        <!-- /row -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div id="aside" class="col-md-3">
           ...
           <form action="searchFutsalServlet" method="post">
              <div class="checkbox-filter">
              <%
              
                    	List<Category> categories = productDao.getListCategorysFutsal();
              ...
              <ul class="store-pagination">
                  ...
                  <c:if test="${numberPage >= 2 && numberPage <=6}">
                     ...
                     <c:forEach begin="${1}" end="${numberPage}" var="i">
                           <li class ="${(requestScope.page) == i ? 'active':''}" ><a class = "numberpage" href="shoeFutsal?page=${i}">${i}</a></li>
                     </c:forEach>
                  </c:if>
				...
				<c:if test="${page !=1}">
					 ...
					 <li >
                         <a class = "numberpage" href="shoeFutsal?page=${page-1}"><i class="fa fa-angle-left"></i></a>
                       </li>
				</c:if>
				...
				<c:if test="${page >= 5}">
					...
					<a class="page-link" href="shoeFutsal?page=${1}">${1}</a>
					</li>
				...
				<c:if test="${page != numberPage}">
					  <li >
                         <a href="shoeFutsal?page=${page+1}"><i class="fa fa-angle-right"></i></a>
                       </li>
				</c:if>
            ...
            <div class="store-filter clearfix">
              ...
              <ul class="store-pagination">
                  ...
                  <c:if test="${numberPage >= 2 && numberPage <=6}">
                     ...
                     <c:forEach begin="${1}" end="${numberPage}" var="i">
                           <li class ="${(requestScope.page) == i ? 'active':''}" >
                               <a class = "numberpage" href="searchFutsalServlet?checkboxSearch=${checkbox}&pricemin=${pricemin}&pricemax=${pricemax}&page=${i}">${i}</a>
                           </li>
                     </c:forEach>
                  </c:if>
				...
				<c:if test="${page !=1}">
					 ...
					 <li >
					 <a class = "numberpage" href="searchFutsalServlet?checkboxSearch=${checkbox}&pricemin=${pricemin}&pricemax=${pricemax}&page=${page-1}"><i class="fa fa-angle-left"></i></a>
				...
				<c:if test="${page >= 5}">
					<li class="page-item ${(requestScope.page) == 1 ? 'active':''}">
					<a class = "numberpage" href="searchFutsalServlet?checkboxSearch=${checkbox}&pricemin=${pricemin}&pricemax=${pricemax}&page=${1}">${1}</a>
				...
				<c:if test="${page != numberPage}">
					  <li >
                       <a class = "numberpage" href="searchFutsalServlet?checkboxSearch=${checkbox}&pricemin=${pricemin}&pricemax=${pricemax}&page=${page+1}"><i class="fa fa-angle-right"></i></a>
                       </li>
				</c:if>
