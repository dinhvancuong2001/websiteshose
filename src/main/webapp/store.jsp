      ...
      <div class="container">
        ...
        <div id="responsive-nav">
          ...
          <ul class="main-nav nav navbar-nav">
            ...
            <li class="active"><a href="store">Tất cả sản phẩm</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div id="aside" class="col-md-3">
            <!-- aside Widget -->
            <div class="aside">
              <h3 class="aside-title">Hãng giày</h3>
           <form action="searchServlet" method="post">
              <div class="checkbox-filter">
              <%
                    	List<String> categories = productDao.getListDistinctCategory();
                        for(String category : categories){
                        	
                    %>
                <div class="input-checkbox">
                 
                  <input type="checkbox" id="category-<%=category%>" name = "checkboxSearch" value="<%=category%>" />
            ...
            <div class="store-filter clearfix">
              ...
              <ul class="store-pagination">
                  ...
                  <c:if test="${numberPage >= 2 && numberPage <=6}">
                     ...
                     <c:forEach begin="${1}" end="${numberPage}" var="i">
                           <li class ="${(requestScope.page) == i ? 'active':''}" >
                               <a class = "numberpage" href="searchHeraderServlet?nameShoe=${namelaptop}&page=${i}">${i}</a>
                           </li>
                     </c:forEach>
                  </c:if>
				...
				<c:if test="${page !=1}">
					 ...
					 <li >
					  <a class = "numberpage" href="searchHeraderServlet?nameShoe=${namelaptop}&page=${page-1}"><i class="fa fa-angle-left"></i></a>
				...
				<c:if test="${page >= 5}">
					<li class="page-item ${(requestScope.page) == 1 ? 'active':''}">
					 ...
					 <a class = "numberpage" href="searchHeraderServlet?nameShoe=${namelaptop}&page=${1}">${1}</a>
					</li>
					<li class="page-item"><a class="page-link">...</a></li>
				</c:if>
				...
				<c:if test="${page != numberPage}">
					  <li >
                         <a class = "numberpage" href="searchHeraderServlet?nameShoe=${namelaptop}&page=${page+1}"><i class="fa fa-angle-right"></i></a>
                       </li>
				</c:if>
